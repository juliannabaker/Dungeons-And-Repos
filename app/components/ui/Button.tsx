...
export default function Button({
  ...
  const variantClasses = {
    ...
    secondary: 'px-8 md:px-10 py-3 md:py-4 rounded-sm border border-purple-500/50 bg-purple-950/20 backdrop-blur-sm text-purple-200/90 hover:bg-purple-950/40 hover:border-purple-500/70 hover:text-purple-100 shadow-md shadow-purple-500/5 hover:shadow-purple-500/15 tracking-wider uppercase text-xs hover:cursor-pointer',
